"""Grade SWE-Rebench patches in a fresh sandbox.

The clean grader prevents reward contamination from the agent's working
sandbox. It applies the held-out test patch and scores pytest tasks only.
"""
