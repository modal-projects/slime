...
``--custom-rollout-log-function-path agentic_rl.obs.metrics.log_rollout_data`` on top
of slime's defaults.
...
def _agentic_metrics(samples, args) -> dict:
    ...
    from agentic_rl.rewards.turn_reward import TURN_RULES, compute_turn_rewards, resolve_turn_strategy
