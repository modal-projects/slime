...
_KNOBS: list[Knob] = [
    ...
    # ------------------------------------------------------------------ #
    _k("ROLLOUT_MODE", "enum", "retro", "launch/launch_config.py", "launcher",
       "retro = mixed retro rollout; vanilla = stock fully-async control arm; "
       "eval = held-out avg@3 protocol (HeldoutEvalSlimeConfig)",
       ("retro", "vanilla", "eval")),
    _k("RETRO_REWARD_ARM", "enum", "final", "launch/launch_config.py", "launcher",
       "Outcome reward arm", ("final", "best")),
    _k("RETRO_PHASE2_GROUPS", "int", "4", "launch/launch_config.py", "launcher",
       "Prompt groups per step (32+ = full 6-node topology + DAPO)"),
    _k("RETRO_PHASE2_ROLLOUTS", "int", "100 if groups>=32 else 1", "launch/launch_config.py", "launcher",
       "Training steps"),
    _k("RETRO_GROUP_RATIO", "fraction", "0.25", "launch/launch_config.py", "launcher",
       "Retro share of each batch → ASYNC_RL_RETRO_GROUP_RATIO"),
    _k("RETRO_TARGET_TRAJECTORY_FRACTION", "fraction", "0.5", "launch/launch_config.py", "launcher",
       "Capture point as a fraction of the trajectory → ASYNC_RL_RETRO_TARGET_TRAJECTORY_FRACTION"),
    _k("RETRO_MAX_FRACTION_ERROR", "fraction", "0.4", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MAX_FRACTION_ERROR"),
    _k("RETRO_CAPTURE_PROMISING_RATIO", "fraction", "0.5", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_CAPTURE_PROMISING_RATIO"),
    _k("RETRO_POOL_PROMISING_RATIO", "fraction", "0.5", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_POOL_PROMISING_RATIO"),
    _k("RETRO_STAGNANT_SUBMISSIONS", "int", "2", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_STAGNANT_SUBMISSIONS"),
    _k("RETRO_PROMISING_CONSECUTIVE", "int", "0", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_PROMISING_CONSECUTIVE"),
    _k("RETRO_SELECTOR_ASSIGNMENT", "enum", "hashed", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_SELECTOR_ASSIGNMENT",
       ("hashed", "alternating", "promising", "recovery", "any")),
    _k("RETRO_SELECTOR_SEED", "int", "20260802", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_SELECTOR_SEED"),
    _k("RETRO_SELECTOR_FALLBACK", "bool", "0", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_SELECTOR_FALLBACK"),
    _k("RETRO_POOL_ORDER", "enum", "newest", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_POOL_ORDER", ("newest", "fifo")),
    _k("RETRO_MIN_SCORE", "float", "0.1", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MIN_SCORE"),
    _k("RETRO_MAX_SCORE", "float", "0.95", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MAX_SCORE"),
    _k("RETRO_MIN_REMAINING", "float", "0.0", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MIN_REMAINING"),
    _k("RETRO_MIN_TURN", "int", "2", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MIN_TURN"),
    _k("RETRO_REGRESSION_DELTA", "float", "0.1", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_REGRESSION_DELTA"),
    _k("RETRO_MIN_POLICY_AGE", "int", "0", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MIN_POLICY_AGE"),
    _k("RETRO_MAX_POLICY_AGE", "int", "4", "launch/launch_config.py", "launcher",
       "→ ASYNC_RL_RETRO_MAX_POLICY_AGE"),
    _k("RETRO_MAX_BEHAVIOR_LAG", "int", "1", "launch/launch_config.py", "launcher",
       "Retro-lane hard lag gate; <= 0 omits the env (falls back to the fresh gate) "
       "→ ASYNC_RL_RETRO_MAX_BEHAVIOR_LAG"),
    _k("RETRO_PREFETCH_BATCHES", "int", "0", "launch/launch_config.py", "launcher",
       "Retro prefetch depth (0 = made-to-order) → ASYNC_RL_RETRO_PREFETCH_BATCHES"),
    _k("RETRO_SEQUENTIAL_LEGS", "bool", "0", "launch/launch_config.py", "launcher",
       "Pre-2026-08-18 fresh-then-retro leg schedule → ASYNC_RL_RETRO_SEQUENTIAL_LEGS"),
    _k("RETRO_MAX_ATTEMPTS", "int", "3", "launch/launch_config.py", "launcher",
    ...
    _k("RETRO_DOWNLOAD_USACO", "bool", "0", "launch/launch_config.py", "launcher",
       "download_data also pulls the USACO dataset"),
    _k("ROLLOUT_PREFETCH_BATCHES", "int", "1", "launch/launch_config.py", "launcher",
       "Fresh-lane in-flight pool = prefetch × rollout_batch_size "
       "→ ASYNC_RL_ROLLOUT_PREFETCH_BATCHES"),
    _k("FRESH_MAX_BEHAVIOR_LAG", "int", "1", "launch/launch_config.py", "launcher",
       "Fresh-lane hard lag gate; <= 0 disables → ASYNC_RL_ROLLOUT_MAX_BEHAVIOR_LAG"),
    _k("DAPO_FILTER", "bool", "1", "launch/launch_config.py", "launcher",
       "Dynamic-sampling zero-std filter (full topology only)"),
    _k("THINK_CLOSURE", "bool", "0", "launch/launch_config.py", "launcher",
    ...
    _k("RESUME", "str", None, "launch/launch_config.py", "launcher",
       "state_tag of the run to resume (checkpoints + manifests)"),
    _k("RESUME_CKPT_STEP", "int", None, "launch/launch_config.py", "launcher",
       "Iteration to load when resuming"),
    _k("FRONTIER_CS_EVAL_ARM", "str", None, "launch/launch_config.py", "launcher",
       "Held-out eval arm key (registry key fills checkpoint identity)"),
    _k("FRONTIER_CS_EVAL_RUN_TAG", "str", "from registry", "launch/launch_config.py", "launcher",
       "Checkpoint run tag under /checkpoints/swe_ckpts (required for unregistered arms)"),
    _k("FRONTIER_CS_EVAL_ID", "str", "frontier-cs-heldout-avg3-<arm>-<stamp>", "launch/launch_config.py", "launcher",
       "Stable output/W&B tag; reuse across train + post_process_data"),
    _k("FRONTIER_CS_EVAL_CKPT_STEP", "int", "from registry", "launch/launch_config.py", "launcher",
       "Checkpoint iteration to evaluate"),
    _k("FRONTIER_CS_EVAL_LOAD", "path", "from registry", "launch/launch_config.py", "launcher",
       "Absolute checkpoint root override (non-training checkpoints)"),
    _k("FRONTIER_CS_EVAL_REFRESH_DATA", "bool", "0", "launch/launch_config.py", "launcher",
       "Re-pull the frontier_cs dataset even if the split exists"),
    # ------------------------------------------------------------------ #
    # Runtime knobs (inside the job; mostly exported by launch_config)
    # ------------------------------------------------------------------ #
    _k("ASYNC_RL_TASK_ROOT", "path", None, "envs/harbor/env.py", "runtime",
       "Directory metadata.task_path resolves against (= /data on Modal); required"),
    _k("ASYNC_RL_REWARD_SHAPE", "enum", "fractional", "rewards/rewards.py", "runtime",
       "Reward shaper", ("fractional", "binary", "thresholded")),
    _k("ASYNC_RL_REWARD_THRESHOLD", "float", "0.1", "rewards/rewards.py", "runtime",
       "thresholded shaper cutoff"),
    _k("ASYNC_RL_OUTCOME_REWARD", "enum", "final", "rewards/rewards.py", "runtime",
       "Episode outcome strategy", ("final", "best", "disc_sum")),
    _k("ASYNC_RL_SOLVED_BONUS", "float", "0", "rewards/rewards.py", "runtime",
       "Additive bonus on solved episodes"),
    _k("ASYNC_RL_OUTCOME_GAMMA", "float", "0.4", "rewards/rewards.py", "runtime",
       "disc_sum discount"),
    _k("ASYNC_RL_TURN_REWARD", "str", "", "rewards/turn_reward.py", "runtime",
       "Per-turn reward strategy ('' = off; e.g. kevin_sum)"),
    _k("ASYNC_RL_TURN_MIX_WEIGHT", "float", "0.3", "rewards/turn_advantage.py", "runtime",
    ...
    _k("SLIME_AGENT_SANDBOX_CPU", "float", None, "core/sandbox.py", "runtime",
       "Task sandbox CPU cores"),
    _k("SLIME_AGENT_SANDBOX_MEMORY_MB", "int", None, "core/sandbox.py", "runtime",
       "Task sandbox memory"),
    _k("AGENTIC_SANDBOX_VM_RUNTIME", "bool", "0", "envs/harbor/env.py", "runtime",
       "Boot task sandboxes as VMs instead of gVisor"),
    _k("AGENT_EVAL_TIMEOUT_SEC", "int", "600", "envs/harbor/env.py", "runtime",
       "Oracle-check CLI eval timeout"),
    _k("HARBOR_VERIFY_DEBUG", "bool", None, "envs/harbor/env.py", "runtime",
       "Verbose harbor verifier logging"),
    _k("FRONTIER_CS_SERVER_VERIFY", "bool", "1", "envs/frontier_cs/env.py", "runtime",
       "Server-side judge scores (contract #8: sandbox submissions log is untrusted)"),
    _k("FRONTIER_CS_SUBMIT_MAX_POLL_TIME", "int", "600", "envs/frontier_cs/env.py", "runtime",
       "Judge poll window per submit"),
    _k("FRONTIER_CS_JUDGE_URL", "str", "", "envs/frontier_cs/env.py", "runtime",
       "Pre-deployed judge URL ('' = per-worker autostart)"),
    _k("FRONTIER_CS_JUDGE_APP", "str", "frontier-cs-judge", "envs/frontier_cs/judge/autostart.py", "runtime",
       "Modal app name for the autostarted judge"),
    _k("FRONTIER_CS_JUDGE_CPU", "float", None, "envs/frontier_cs/judge/autostart.py", "runtime",
       "Judge container CPUs"),
    _k("FRONTIER_CS_JUDGE_MEMORY_MB", "int", None, "envs/frontier_cs/judge/autostart.py", "runtime",
       "Judge container memory"),
    _k("FRONTIER_CS_JUDGE_IDLE_EXIT_MIN", "int", "25", "envs/frontier_cs/judge/autostart.py", "runtime",
       "Judge idle self-shutdown"),
    _k("FRONTIER_CS_DATA_VOLUME", "str", "slime-data", "envs/frontier_cs/judge/autostart.py", "runtime",
       "Volume the judge mounts for problems/"),
    _k("FRONTIER_CS_PROBLEMS_ROOT", "path", "/data/frontier_cs/problems", "envs/frontier_cs/judge/autostart.py", "runtime",
       "Judge testdata root"),
