...
# for every retro arm. Same 0.5.18/EAGLE stack, 100 updates, save every 10.
set -euo pipefail
cd "$(dirname "$0")/../.."
...
echo "Launching ${WANDB_GROUP}-${LAUNCH_STAMP} (retro path @ ratio 0, prefetch 4, gate 4, sglang ${SGLANG_VERSION})"
