...
from agentic_rl.core import prompts
...
ENVS: dict[str, str] = {
    "harbor": "agentic_rl.envs.harbor.env:HarborEnv",
    "frontier_cs": "agentic_rl.envs.frontier_cs.env:FrontierCsEnv",
    "swerebench": "agentic_rl.envs.legacy.swerebench_env:SweRebenchEnv",
}
