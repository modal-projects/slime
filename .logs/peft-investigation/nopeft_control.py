...
train_args = ckpt_args + rollout_args + optimizer_args + ppo_args + ci_args + sglang_args + misc_args + parallel_args
print("[NO-PEFT CONTROL] train_args:", train_args)
U.execute_train(train_args=train_args, num_gpus_per_node=NUM_GPUS, megatron_model_type=MODEL_TYPE)
print("[NO-PEFT CONTROL] completed")
